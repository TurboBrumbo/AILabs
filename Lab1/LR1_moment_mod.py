...
""" Реализация градиентного спуска с моментной модификацией """
def gradient_descent(start_x, start_y, learning_rate=0.01, mom=0.7, iter=2500):
    x, y = start_x, start_y
    x_prev, y_prev = x, y
    history = [(x, y, f(x, y))]
...
x_opt, y_opt, history = gradient_descent(start_x, start_y, learning_rate, mom, iterations)
