# Данные об обучении сохраняются в виде таблиц
# Таблицы импортируются в базу данных формата SQLite
# В данной работе - lroptuna.db

# Через переменную storage мы указываем, куда сохраняем таблицы
# Используя формат "sqlite:///<filename>.db", мы сохраняем базу данных в директории проекта
# Для просмотра полученной реляционной бд используется программа
# DB Browser for SQLite: https://sqlitebrowser.org/dl/
# В ней открываем бд из директории проекта
# Итоговая бд содержит 13 таблиц
